...
public class OperacionesUsuarios implements Operacion<Usuario>{
    ...
    private final String sqlCrear= "INSERT INTO Usuarios (nombreUsuario,contrasenia,esAdmin) VALUES (?,?,?)";
    private final String sqlConsultaALL= "select * from Usuarios  ";
    @Override
    public boolean crear(Usuario dato) {
        ...
        Connection conexActiva = mc.conectarseSQLite();
        if (conexActiva != null){
